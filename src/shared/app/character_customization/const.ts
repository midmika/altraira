export const eyeColorsCount = 30;

export const facialHairList: string[] = [
    'Stubble',
    'Balbo',
    'Circle Beard',
    'Goatee',
...
export const maleHairList: string[] = [
    'Close Shave',
    'Buzzcut',
    'Faux Hawk',
...
export const femaleHairList: string[] = [
    'Close Shave',
    'Short Bob',
    'Bob',
    'Pigtails',
...
export const maleHairOverlays: Record<number, { collection: string; overlay: string }> = {
...
export const femaleHairOverlays: Record<number, { collection: string; overlay: string }> = {
    0: { collection: 'mpbeach_overlays', overlay: 'FM_Hair_Fuzz' },
...
export const faceNameList: string[] = [
    'Benjamin',
    'Daniel',
    'Joshua',
    'Noah',
...
export const eyebrowNamesList: string[] = [
    'Balanced',
    'Fashion',
    'Cleopatra',
    'Quizzical',
