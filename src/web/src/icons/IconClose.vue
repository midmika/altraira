...
const { color = 'white', cursor = 'initial', size = 'medium' } = defineProps<IIconsProps>();
...
<template>
    <svg :style="{ height, cursor }" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
